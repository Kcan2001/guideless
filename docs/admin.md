...
| `/admin/departures/[id]/trips/[tripId]`      | **Live itinerary editor** (snapshot; edits are what travelers see), trip status, members, **Rooms** (per booking and room, stay tier), **Live Moments** (create official moments as announced or draft; announce / start / finish / cancel; traveler-suggested ones with head-counts), staff notes                                                                     |
