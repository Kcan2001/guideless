...
| `/admin/departures/[id]/trips/[tripId]`      | **Live itinerary editor** (snapshot; edits are what travelers see), trip status, members, staff notes                                                                                                               |
...
Bulk communications, live moments management, support inbox, content/CMS editing, analytics and
audit-log screens, role administration UI (use SQL for now), image uploads to Storage.
