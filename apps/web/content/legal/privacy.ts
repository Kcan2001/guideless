  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        ...
        "Location, to show what is near you: we use your device location to answer “what is good around here right now” and to tell you how far your next stop is — questions we cannot answer without knowing where you are. Only while the app is open, only if you grant permission, and the answer is worked out and the position discarded. Nothing is stored. Say no and the rest of the app works exactly as before; you can change your mind at any time in your phone’s settings.",
        "Location, shared with your group: so people on the same trip can find each other — at a station, at a viewpoint, before a morning swim. This is the only reason we do it. It is off unless you switch it on, you choose how long it lasts, and you can stop at any moment: stopping deletes your position rather than hiding it. While it is on we keep only your latest position and never a history of where you have been; it ends by itself when the time you chose runs out, and never runs for more than twelve hours without you turning it on again. Only people on that trip can see it, anyone you have blocked cannot, we never share it while the app is closed, and our own staff cannot see it either. You never have to switch it on, and nobody is told whether you did.",
    ...
    },
    {
      ...
      list: [
        ...
        "For safety: emergency contacts are used only in an emergency; staff can see traveler details to help during the trip. Staff cannot see your location.",
