  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        ...
        "Location, to show what is near you: only while the app is open and only if you grant permission. This is used to answer the question and is not stored.",
        "Location, shared with your group: only if you switch it on yourself, only for the length of time you choose, and only visible to people on the same trip. We keep just your latest position, never a history of where you have been; it stops automatically when the time you chose runs out, and turning it off deletes it. We never share your location while the app is closed, and our staff cannot see it.",
