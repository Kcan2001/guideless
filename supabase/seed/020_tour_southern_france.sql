...
-- Free time is deliberate. Every item states who arranges it.
...
values
  ('21000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', 1, 'published',
   ...
   'Nine days from the Mediterranean to the Seine. We book the hotels, the trains and a handful of experiences worth showing up for. You fly into Nice, meet a small group, and explore each city at your own pace.',
...
insert into public.tour_included_items (tour_version_id, position, title, description) values
  ...
  ('21000000-0000-4000-8000-000000000001', 4, 'Châteauneuf-du-Pape wine afternoon', 'A small-producer tasting with lunch. Optional, included.'),
  ('21000000-0000-4000-8000-000000000001', 5, 'Welcome drinks and a farewell dinner', 'Both optional. Both good.'),
  ('21000000-0000-4000-8000-000000000001', 6, 'Your digital guide', 'Daily itinerary, maps, curated recommendations, group chat and real human support.');
...
insert into public.tour_faqs (tour_version_id, position, question, answer) values
  ...
  ('21000000-0000-4000-8000-000000000001', 4, 'Can I book for two people?', 'Yes. Add each traveler at checkout. You can choose a shared room or singles.');

-- Days
insert into public.tour_days (id, tour_version_id, day_number, destination_id, title, summary) values
  ('22000000-0000-4000-8000-000000000001', '21000000-0000-4000-8000-000000000001', 1, '10000000-0000-4000-8000-000000000001', 'Arrive in Nice', 'Land, meet the group on the welcome drive, settle in. Drinks at seven if you feel like it.'),
  ...
  ('22000000-0000-4000-8000-000000000005', '21000000-0000-4000-8000-000000000001', 5, '10000000-0000-4000-8000-000000000002', 'Wine afternoon', 'Free morning. Châteauneuf-du-Pape tasting and lunch, optional and included.'),
  ...
  ('22000000-0000-4000-8000-000000000008', '21000000-0000-4000-8000-000000000001', 8, '10000000-0000-4000-8000-000000000003', 'Paris, and a last dinner', 'Free day. Farewell dinner at eight, optional.'),
...
values
  ...
  ('22000000-0000-4000-8000-000000000001', 5, 'live_moment', 'Welcome drinks', 'Hotel terrace. Come and go as you like.', '19:00', '20:30', 'Europe/Paris', 'Hotel terrace', 'guideless', true, 'public_preview'),
  -- Day 2
  ...
  ('22000000-0000-4000-8000-000000000002', 4, 'free_time',   'Afternoon on the Promenade', 'Rent a bike, swim, or do nothing.', '14:00', null, 'Europe/Paris', 'Promenade des Anglais', 'traveler', false, 'public_preview'),
  -- Day 3
  ...
  ('22000000-0000-4000-8000-000000000005', 3, 'activity',    'Châteauneuf-du-Pape tasting and lunch', 'Small producer, long table, four wines.', '13:00', '17:00', 'Europe/Paris', 'Châteauneuf-du-Pape', 'guideless', true, 'public_preview'),
  ...
  ('22000000-0000-4000-8000-000000000008', 2, 'activity',    'Farewell dinner', 'A neighborhood bistro, one long table. Optional, included.', '20:00', '22:30', 'Europe/Paris', 'Le Marais', 'guideless', true, 'public_preview'),
  -- Day 9
  ...
  ('22000000-0000-4000-8000-000000000009', 2, 'flight',      'Fly home', 'RER B to CDG is 45 minutes; Orlyval to ORY is 35.', null, null, 'Europe/Paris', 'CDG / ORY', 'traveler', false, 'public_preview');
