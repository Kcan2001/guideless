-- Seed: destinations for the first route (Southern France). Local/staging only.
...
values
  ('10000000-0000-4000-8000-000000000001', 'nice', 'Nice', 'FR', 'France', 'Côte d''Azur', 'Europe/Paris',
   43.7102, 7.2620,
   'Belle Époque promenades, a pastel old town and the bluest water on the Riviera.',
  ...
  ('10000000-0000-4000-8000-000000000002', 'avignon', 'Avignon', 'FR', 'France', 'Provence', 'Europe/Paris',
   43.9493, 4.8055,
   'Papal palaces, plane-tree squares and vineyards in every direction.',
   '{"general":"112","police":"17","ambulance":"15","fire":"18"}', true),
